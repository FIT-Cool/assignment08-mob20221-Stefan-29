...
interface NewsApi {
    ...
    @GET("v2/everything?q=Apple&from=2022-11-20&sortBy=popularity&apiKey=f0c081794a864a8ca72ebbebc350efc9")
    fun getNews(@Query("q") mention: String?, @Query("apiKey") apiKey: String): Call<ArticlesJson?>?
}
